...
if len(msgs.messages) == 0:
    msgs.add_ai_message("How I am you fashion assistant 👋. I can help you find your next outfit.👗 ")
...
def tab1(st):
    ...
    st.caption("This is a demo of a chatbot that can help you find your next outfit.")
